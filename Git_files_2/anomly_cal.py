...
monthly_average.to_csv('E:\share\BIgRun\Watershed_Cal\mean_cal_V4.csv')
...
hist_monthly_average.to_csv(r'E:\share\BIgRun\Watershed_Cal\WS3\anamoly_calculated_dataV4_500.csv')