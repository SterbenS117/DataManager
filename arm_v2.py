...
if k == 2:
    for era in eras:
        static_home = '/mnt/d/ARM/Era3/Static_1400/ERA3_' + era +'/'
        lst_dir = '/mnt/d/%s/TXson' % 'Temp'
        input_dir = '/mnt/d/ARM/Era3/ERA3_' + era +'/All_Data'
        fourteen = []
        for f in os.listdir(input_dir):
            if f.endswith("1400.csv"):
                fourteen.append(f)
        ...
        for k in range(1, 53):
            ...
            if k == 52:
                f_data.to_csv('ARM_1400m_dataV1_Era3' + era +'.csv')
    #k = 3
if k == 3:
    for era in eras:
        data = pd.read_csv('ARM_1400m_dataV1_Era3' + era +'.csv')
        ...
        data1 = data1.dropna()
        data1.to_csv('ARM_1400m_data_pEra3' + era +'.csv', index=False)
    k = 4
if k == 4:
    for o in range(1,5):
        ...
        if o == 4:
            ...
            fourteenm = ["H10", "AV98", "AV180", "BL22"]
        data = pd.read_csv('ARM_1400m_data_pEra3'+str(o)+'.csv',
        ...
        df_train.to_csv('Era3_' + str(o) + 'ARM_1400m_dataV1_train.csv', index=False)
        df_test.to_csv('Era3_' + str(o) + 'ARM_1400m_dataV1_test.csv', index=False)
        ###################################################################################################
